...
def resnet(n_layers, stride):
    ...
    pretrained_path = {
        50: Path(__file__).resolve().parent / 'models' / 'resnet50-ebb6acbb.pth',
        101: Path(__file__).resolve().parent / 'models' / './models/resnet101-2a57e44d.pth',
        152: Path(__file__).resolve().parent / 'models' / './models/resnet152-0d43d698.pth',
    }[n_layers]
